...
def get_images(root_path):
    train_images = glob.glob(f"{root_path}/train/image/*")
    train_images.sort()
    train_masks = glob.glob(f"{root_path}/train/mask/*")
    train_masks.sort()
    valid_images = glob.glob(f"{root_path}/valid/image/*")
    valid_images.sort()
    valid_masks = glob.glob(f"{root_path}/valid/mask/*")
    valid_masks.sort()
