...
def validate(
    ...
    ##########################
    ious = metric.compute(num_labels=num_classes, ignore_index=255, reduce_labels=True)
    print('ious', ious)
    iou = ious['mean_iou']
    # calculate = metric.compute(num_labels=num_classes, ignore_index=255, reduce_labels=True)
